...
static const _OrderFood_Request_type_support_symbol_names_t _OrderFood_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav_interfaces, srv, OrderFood_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav_interfaces, srv, OrderFood_Request)),
  }
};
...
{
  return &::nav_interfaces::srv::rosidl_typesupport_cpp::OrderFood_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nav_interfaces, srv, OrderFood_Request)() {
  return get_message_type_support_handle<nav_interfaces::srv::OrderFood_Request>();
}
...
static const _OrderFood_Response_type_support_symbol_names_t _OrderFood_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav_interfaces, srv, OrderFood_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav_interfaces, srv, OrderFood_Response)),
  }
};
...
{
  return &::nav_interfaces::srv::rosidl_typesupport_cpp::OrderFood_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nav_interfaces, srv, OrderFood_Response)() {
  return get_message_type_support_handle<nav_interfaces::srv::OrderFood_Response>();
}
...
static const _OrderFood_type_support_symbol_names_t _OrderFood_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav_interfaces, srv, OrderFood)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav_interfaces, srv, OrderFood)),
  }
};
...
{
  return &::nav_interfaces::srv::rosidl_typesupport_cpp::OrderFood_service_type_support_handle;
}
