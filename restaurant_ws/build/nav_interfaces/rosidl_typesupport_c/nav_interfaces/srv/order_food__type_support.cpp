...
static const _OrderFood_Request_type_support_symbol_names_t _OrderFood_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nav_interfaces, srv, OrderFood_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_interfaces, srv, OrderFood_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nav_interfaces, srv, OrderFood_Request)() {
  return &::nav_interfaces::srv::rosidl_typesupport_c::OrderFood_Request_message_type_support_handle;
}
...
static const _OrderFood_Response_type_support_symbol_names_t _OrderFood_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nav_interfaces, srv, OrderFood_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_interfaces, srv, OrderFood_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nav_interfaces, srv, OrderFood_Response)() {
  return &::nav_interfaces::srv::rosidl_typesupport_c::OrderFood_Response_message_type_support_handle;
}
...
static const _OrderFood_type_support_symbol_names_t _OrderFood_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nav_interfaces, srv, OrderFood)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav_interfaces, srv, OrderFood)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, nav_interfaces, srv, OrderFood)() {
  return &::nav_interfaces::srv::rosidl_typesupport_c::OrderFood_service_type_support_handle;
}
