...
#include "nav_interfaces/srv/detail/order_food__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav_interfaces::srv::OrderFood_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav_interfaces::srv::OrderFood_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nav_interfaces::srv::OrderFood_Request *>(
    untyped_ros_message);
...
{
  return &nav_interfaces::srv::typesupport_fastrtps_cpp::_OrderFood_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav_interfaces::srv::OrderFood_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav_interfaces::srv::OrderFood_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<nav_interfaces::srv::OrderFood_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &nav_interfaces::srv::typesupport_fastrtps_cpp::_OrderFood_Response__handle;
}
...
{
  return &nav_interfaces::srv::typesupport_fastrtps_cpp::_OrderFood__handle;
}
