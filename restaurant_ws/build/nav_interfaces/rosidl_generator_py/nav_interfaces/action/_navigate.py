    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'nav_interfaces.action.Navigate_Goal')
            logger.debug(
...
class Metaclass_Navigate_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'nav_interfaces.action.Navigate_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Navigate_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'nav_interfaces.action.Navigate_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate_SendGoal_Request(metaclass=Metaclass_Navigate_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'nav_interfaces/Navigate_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['nav_interfaces', 'action'], 'Navigate_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from nav_interfaces.action._navigate import Navigate_Goal
...
class Metaclass_Navigate_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'nav_interfaces.action.Navigate_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from nav_interfaces.action import _navigate
...
class Navigate_SendGoal(metaclass=Metaclass_Navigate_SendGoal):
    from nav_interfaces.action._navigate import Navigate_SendGoal_Request as Request
    from nav_interfaces.action._navigate import Navigate_SendGoal_Response as Response
...
class Navigate_GetResult_Response(metaclass=Metaclass_Navigate_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'nav_interfaces/Navigate_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['nav_interfaces', 'action'], 'Navigate_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from nav_interfaces.action._navigate import Navigate_Result
...
class Metaclass_Navigate_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'nav_interfaces.action.Navigate_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate_GetResult(metaclass=Metaclass_Navigate_GetResult):
    from nav_interfaces.action._navigate import Navigate_GetResult_Request as Request
    from nav_interfaces.action._navigate import Navigate_GetResult_Response as Response
...
class Metaclass_Navigate_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'nav_interfaces.action.Navigate_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate_FeedbackMessage(metaclass=Metaclass_Navigate_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'nav_interfaces/Navigate_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['nav_interfaces', 'action'], 'Navigate_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from nav_interfaces.action._navigate import Navigate_Feedback
...
class Metaclass_Navigate(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'nav_interfaces.action.Navigate')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate(metaclass=Metaclass_Navigate):
    ...
    from nav_interfaces.action._navigate import Navigate_Goal as Goal
    # The result message defined in the action definition.
    from nav_interfaces.action._navigate import Navigate_Result as Result
    # The feedback message defined in the action definition.
    from nav_interfaces.action._navigate import Navigate_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from nav_interfaces.action._navigate import Navigate_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from nav_interfaces.action._navigate import Navigate_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from nav_interfaces.action._navigate import Navigate_FeedbackMessage as FeedbackMessage
