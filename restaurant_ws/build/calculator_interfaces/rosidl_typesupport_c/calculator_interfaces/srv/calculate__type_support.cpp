...
static const _Calculate_Request_type_support_symbol_names_t _Calculate_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, calculator_interfaces, srv, Calculate_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, calculator_interfaces, srv, Calculate_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, calculator_interfaces, srv, Calculate_Request)() {
  return &::calculator_interfaces::srv::rosidl_typesupport_c::Calculate_Request_message_type_support_handle;
}
...
static const _Calculate_Response_type_support_symbol_names_t _Calculate_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, calculator_interfaces, srv, Calculate_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, calculator_interfaces, srv, Calculate_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, calculator_interfaces, srv, Calculate_Response)() {
  return &::calculator_interfaces::srv::rosidl_typesupport_c::Calculate_Response_message_type_support_handle;
}
...
static const _Calculate_type_support_symbol_names_t _Calculate_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, calculator_interfaces, srv, Calculate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, calculator_interfaces, srv, Calculate)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, calculator_interfaces, srv, Calculate)() {
  return &::calculator_interfaces::srv::rosidl_typesupport_c::Calculate_service_type_support_handle;
}
